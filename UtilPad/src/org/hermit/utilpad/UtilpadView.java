	...
	extends SurfaceRunner
{
	 ...
	 */
	public UtilpadView(Utilpad context) {
		super(context);
		appContext = context;
     ...
     * @param	context			Parent application context.
     */
    private void createGui(Utilpad context) {
     ...
     */
    void setDataUnits(Utilpad.Unit unit) {
        for (ViewDefinition vdef : ViewDefinition.values())
    ...
    protected void doDraw(Canvas canvas, long now) {
        if (currentView != null) {
            canvas.drawColor(Utilpad.COL_BG);
