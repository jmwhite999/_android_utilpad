...
import org.hermit.utilpad.utilpadView.ViewDefinition;
...
/**
 * The utilpad navigation control, consisting of the buttons at the left.
 */
class NavigationBar
	extends LinearLayout
{
	 ...
	 */
	NavigationBar(utilpad parent, int width, int height) {
		super(parent);
	 ...
	 * @param	height			Height available for the nav bar.
     */
    private void createGui(utilpad parent, int width, int height) {
	...
	private static final String TAG = "utilpad";
