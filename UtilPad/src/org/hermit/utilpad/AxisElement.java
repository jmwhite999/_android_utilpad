	...
	extends Gauge
{
	...
	public void setDataColors(int grid, int plot) {
		...
		xGauge.setDataColors(grid, utilpad.COL_POINTER);
		yGauge.setDataColors(grid, utilpad.COL_POINTER);
		zGauge.setDataColors(grid, utilpad.COL_POINTER);
		xyAxes.setDataColors(grid, plot);
		altDial.setDataColors(grid, utilpad.COL_POINTER);
	}
